...
$search_query = "SELECT ID,Firstname,Middle_Initial,Lastname,Suffix,Load_Balance FROM user";
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <!-- /.box-header -->
            <div class="box-body">
			<input type="text" id="myInput" value="0" onkeyup="myFunction()" autofocus> <!-- onfocus="if(this.value=='esc') this.value='';" -->
              ...
              <table id="myTable" class="table table-bordered table-hover">
				...
				{
					echo "<tr><td class='ID_Number' style='display:none;'>".$data['ID']."</td><td>".
								$data['Firstname']." ".
								$data['Middle_Initial']." ".
								$data['Lastname']." ".
								$data['Suffix']."</td><td>".
								$data['Load_Balance']."</td>
...
<script>
var input, filter, table, tr, td, i, dd;
function myFunction() {
