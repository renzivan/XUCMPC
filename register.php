...
<head>
  ...
  <title>Magis Canteen | Registration</title>
...
<div class="register-box">
  ...
  <div class="register-box-body">
    ...
    <form action="php/addUser.php" method="POST">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="First Name" autofocus name="reg_fname" pattern="[a-zA-Z ]{1,}" autocomplete="off" title="Use only letters and a space" required>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Last Name" name="reg_lname"pattern="[a-zA-Z ]{1,}" autocomplete="off" title="Use only letters and a space" required>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="MI" name="reg_mname" pattern="[a-zA-Z.]{1,}" autocomplete="off" title="Use only letters and a period" required>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Suffix" name="reg_suffix" autocomplete="off" pattern="[a-zA-Z.]{1,}"  title="Use only letters">
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
      ...
      <div class="form-group has-feedback">
        <input type="text" class="form-control" placeholder="Card No." name="reg_idno" pattern="[0-9]{1,20}" autocomplete="off" title="Use only numbers and the limit is 20" required>
        <span class="glyphicon glyphicon-user form-control-feedback"></span>
      </div>
      <div class="form-group has-feedback">
