...
<?php 
      include('php/session.php');
          $search_query = "SELECT * FROM product ORDER BY Product_Name asc";
          ...
          <table class="table table-striped" id="myTable">
            ...
            <tbody>
                ...
                <?php
                    while ($data = mysqli_fetch_assoc($search_query_result)){
                        echo "
                        <form action='databasus_edit.php' method='POST'>
                        <tr>
                                <td><input type='hidden' class='form-control' name='trans_id' autocomplete='off' value=".$data['ID']." />".$data['ID']."</td>
                                <td><input type='text' class='form-control' name='trans_name' autocomplete='off' value=".$data['Product_Name']."></td>
                                <td><input type='text' class='form-control' name='trans_price' autocomplete='off' value=".$data['Price']."></td>
                                <td><input type='text' class='form-control'  name='trans_qty' style='width:50px;' value=".$data['Quantity']."></td>
                                <td>
